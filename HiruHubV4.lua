...
Tabs.infor:AddButton({
        ...
        Callback = function()
        setclipboard("https://discord.com/invite/5FzqgJTh")
        end
    })
...
local SelectFastAttackMode = (SelectFastAttackMode or "HiruHub Fast")

SelectedFastAttackMode = {"Normal Attack","Fast Attack","HiruHub Fast"}
...
local function ChangeModeFastAttack(SelectFastAttackMode)
	...
	elseif SelectFastAttackMode == "Fast Attack" then
		FireCooldown = 0.07
	elseif SelectFastAttackMode == "HiruHub Fast" then
		FireCooldown = 0.02
	end
end
...
local Toggle = Tabs.Race:AddToggle("Teleport Gear", { Title = "Teleport To Advanced Fruit Dealer", Default = false })
Toggle:OnChanged(function(Value)
    _G.RaDaoKhi = Value
...
local Toggle = Tabs.Race:AddToggle("Auto Complete Trial", { Title = "Auto Done Trial V4", Default = false })
...
Tabs.Race:AddParagraph({
        Title = "•Add Skill",
        Content = "Use Skill Melee,If You Want To Kill Fast"
    })
...
Toggle:OnChanged(function(HiruHub)
    ConCacC = HiruHub
end)
