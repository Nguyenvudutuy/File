...
local Tabs = {
    ...
    Race = Window:AddTab({ Title = "Tab Upgrade Race", Icon = "" }),
     ...
     Fake = Window:AddTab({ Title = "Tab Fake", Icon = "" }),
...
local ToggleEspRealFruit = Tabs.pvp:AddToggle("ToggleEspRealFruit", {Title = "ESP Real Fruit",Description = "", Default = false })
...
Tabs.Fake:AddInput("Input_Level", {
    Title = "Level",
    Default = "",
    Placeholder = "input",
    Numeric = false, 
...
Tabs.Fake:AddInput("Input_Fragments", {
    Title = "Fragments",
    Default = "",
    Placeholder = "input",
    Numeric = false, 
