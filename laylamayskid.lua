...
local ToggleWhiteScreen = Tabs.LGa:AddToggle("ToggleWhiteScreen", {
    Title = "White Screen",
    Description = "",
    Default = false })
...
local USERACEV3 = Tabs.Settings:AddToggle("UseV3", {Title = "Auto Turn On Race V3", Default = false })
...
local USERACEV4 = Tabs.Settings:AddToggle("UseV4", {Title = "Auto Turn On Race V4", Default = true })
...
local DropdownTweenSpeed = Tabs.Main:AddDropdown("DropdownTweenSpeed", {
    Title = "Speed Tween",
    Values = {"100", "250", "275", "300", "325", "350"},
    Multi = false,
    Default = 300,
})
...
local AtikiDoughKing = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Kill Dough King", Description = "" ,Default = _G.AtikiDoughKing })
...
local Dropdown = Tabs.Sub:AddDropdown("Dropdown", {
...
local CoNguoiDoiGietTao = Tabs.Sub:AddToggle("MyToggle", {Title = "Auto Farm Material", Default = _G.AutoFarmMaterial })
...
TelepiToFut = Tabs.Sub:AddToggle("MyToggle", {Title = "Teleport To Fruit", Description = "" ,Default = _G.TelepiToFut })
...
TelepiToFutHop = Tabs.Sub:AddToggle("MyToggle", {Title = "Teleport To Fruit Hop", Description = "" ,Default = _G.TelepiToFutHop })
...
Toggle = Tabs.Race:AddToggle("MyToggle", {Title = "Teleport To Migare Island", Default = _G.AutoMysticIsland })
    Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Race:AddToggle("MyToggle", {Title = "Teleport To Gear", Default = _G.TweenMGear })
    Toggle:OnChanged(function(Value)
        _G.TweenMGear = Value
        saveSettings()
        end)
...
Toggle = Tabs.Race:AddToggle("MyToggle", {Title = "Teleport To Trial Door", Default = false })
Toggle:OnChanged(function(Value)
    _G.RaceCua = Value
...
Toggle = Tabs.Race:AddToggle("MyToggle", {Title = "Auto Done Trial V4", Default = _G.AutoQuestRace })
    Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Race:AddToggle("MyToggle", {Title = "Auto Kill Player After Trial V4", Default = KillPlayer })
    Toggle:OnChanged(function(Value)
        KillPlayer = Value
